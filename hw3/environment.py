...
def create_ur5e_robotiq85f():
    try:
        ...
        # If not found, try a relative path or provide a helpful error
        print("Error: MuJoCo Menagerie not found. Please install it by running:")
        print("git clone https://github.com/deepmind/mujoco_menagerie.git")
